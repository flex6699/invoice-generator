...
function App() {
  ...
  const [shopName, setshopName] = useState("The Horizon Restro & Cafe");
  const [shopDes, setshopDes] = useState("Restaurant And Cafe");
  const [shopAdd, SetshopAdd] = useState(
    "BAGESHWAR, UTTARAKHAND, INDIA, 263642"
  );
  const [notes, setNotes] = useState(
    "Thank you for dining with us! Every visit means the world to us, and we’re thrilled you chose our restaurant today."
  );
